...
bool Colors::load(const std::filesystem::path& colorFile, const std::map<string, uint8_t>& filter, Palette* colors) {
	FILE *f = fopen(colorFile.c_str(), "r");
    json data;
