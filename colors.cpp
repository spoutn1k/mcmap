...
{	// Colors are mostly the same as in Cartograph
	...
	SETCOLORNOISE(STONE, 125,125,125,255, 6);
	SETCOLOR(GRASS, 117,176,73,255);
	SETCOLOR(DIRT, 134,96,67,255);
	SETCOLORNOISE(COBBLESTONE, 110,110,110,255, 12);
	SETCOLORNOISE(WOOD, 157,128,79,255, 5);
