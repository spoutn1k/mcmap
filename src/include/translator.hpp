...
void swap16(const uint8_t *src, uint8_t *dest) {
  dest[0] = src[1];
  dest[1] = src[0];
}

void swap32(const uint8_t *src, uint8_t *dest) {
  dest[0] = src[3];
  dest[1] = src[2];
  dest[2] = src[1];
  dest[3] = src[0];
...
void swap64(const uint8_t *src, uint8_t *dest) {
  dest[0] = src[7];
  dest[1] = src[6];
  dest[2] = src[5];
  dest[3] = src[4];
...
ArithmeticType translate(const uint8_t *_bytes) {
  ...
  return *static_cast<ArithmeticType *>(buffer);
}
